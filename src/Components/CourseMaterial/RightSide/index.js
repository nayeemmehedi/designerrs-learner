...
const RightSide = ({ active }) => {
  ...
  const videoFiles = studyMaterial?.filter(
    (item) => item?.studyMaterialType === "video"
  );
  ...
  return (
    <div className="p-2">
        ...
        <div>
          <div className="d-flex justify-content-between text-secondary">
            ...
            <div>
              ...
              <small className="mx-2">{mentors[1]?.name} + 1</small>
            </div>
          </div>
          {videoFiles?.map((i) => {
            return (
      ...
      {active == "Assignment" && (
        <>
          <div className="d-flex">
            {role == "mentor" && (
              <div className="me-4" onClick={() => setRightSideToggle(false)}>
                <span
                  style={
                    !rightSideToggle
                      ? { borderBottom: "3px solid #cd2026", cursor: "pointer" }
                      : {
            ...
            <div onClick={() => setRightSideToggle(true)}>
              <span
                style={
                  rightSideToggle
                    ? { borderBottom: "3px solid #cd2026", cursor: "pointer" }
      ...
      {(rightSideToggle || role == "learner") && active == "Assignment" && (
        <Comment />
      )}
      {!rightSideToggle && role == "mentor" && active == "Assignment" && (
        <Overview />
      )}
      {active == "Mentor" && (
        <div>
