...
const history = useHistory();
  const handleFinish = () =>{
    axiosApi
    .patch(`/mentor/courses/${batchId}/onboarding`, {onboardingCompleted : true})
    .then((res) => {
      console.log(res);
      ...
      <div className="row">
        <div className="col-6 mt-2">
          ...
          <p className="mt-4">
            ...
            itaque ipsam suscipit distinctio !
          </p>
        </div>

        <div className="mt-3 bg-white col-10">
          <div className="p-4">
            {onBoarding?.softwaresToInstall?.map((i) => (
        ...
        <div className="topMargin my-3">
          <div className="d-flex justify-content-between  whiteColor downloadmain">
            ...
            <div className="p-4">
              <button className="p-4 finishBtn" onClick={handleFinish}>Finish</button>
            </div>
          </div>
        </div>
