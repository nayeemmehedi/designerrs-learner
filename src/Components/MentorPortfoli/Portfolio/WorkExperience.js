      ...
      <div className={PortfolioContext ? "bgGray p-4 shadow-sm " : " p-4"}>
        <div>
          <div className="d-flex justify-content-between">
            <p className="fs-5 iconColor">Work Experience</p>
            {PortfolioContext && (
              <button
              ...
              >
                ...
                <p className="d-none d-sm-inline"> Add Work Experience</p>
              </button>
            )}
          </div>
        </div>
          ...
          <div className="row">
            {portfolioValue?.workExperience?.map((value, idx) => (
              <div className="col-12" key={idx}>
                <div
                  className={
                    PortfolioContext ? "shadow-sm my-2 p-3" : "my-2 p-3"
                  }
                >
