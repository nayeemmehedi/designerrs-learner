...
import { getFilterWeekData } from "../../Store/PandingAssignment/action";
...
const [checkValue,setCheckValue] = useState([])
  ...
  const onSubmit = () => {
    // dispatch(dispatch(getAllPages(0, 10, filter)));
    dispatch({type: "REMOVE_DATA"})
    dispatch(getFilterWeekData("2021-05-14T18:00:00.000Z", "2022-05-21T17:59:59.999Z",checkValue));
    // let totalFilter = { ...filter, application: application };
